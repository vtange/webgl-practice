...
function main(){
 ...
 var targetSeenColour = "255, 0, 255"; //purple, orange overlay makes it look red
 ...
 function shootRays(rays, blockingEdges, sector) {
   ...
   var prevPointOnArc = false,
     prevUnitRay = vec2.create();
 ...
 function handleClick(e) {
   scene.observer.loc = relMouseCoords(e, canvas);
   window.requestAnimationFrame(mainLoop);
 }

 function handleMouseMove(e) {
   var lookAt = relMouseCoords(e, canvas);
